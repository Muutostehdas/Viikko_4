...
$(document).ready(function(){
	...
	//Haetaan muutettavan asiakkaant tiedot. Kutsutaan backin GET-metodia ja välitetään kutsun mukana muutettavan tiedon id
	//GET /asiakkaat/haeyksi/asiakas_id
	var etunimi = requestURLParam("asiakas_id"); //Funktio löytyy scripts/main.js 	
